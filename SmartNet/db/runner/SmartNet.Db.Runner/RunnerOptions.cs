...
public sealed record RunnerOptions(string ConnectionString, string ScriptsPath)
{
    public const string Usage =
        ...
        "  --scripts-path  Optional. Defaults to SmartNet/db/schema/ resolved from the repo root.";
    ...
    /// (a `.git` directory) and returns `&lt;repo-root&gt;/SmartNet/db/schema`. Kept independent of
