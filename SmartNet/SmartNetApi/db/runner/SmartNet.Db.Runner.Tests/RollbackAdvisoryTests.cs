...
/// <summary>
/// Task 5.4 — `SmartNet/SmartNetBD/schema/rollback/NNN_down.sql` scripts must be advisory: authored,
...
public sealed class RollbackAdvisoryTests
{
    ...
    // The real guardian: every forward script under SmartNet/SmartNetBD/schema/ has a same-numbered
