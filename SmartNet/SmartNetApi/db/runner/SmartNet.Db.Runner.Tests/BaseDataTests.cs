...
/// every script under `SmartNet/SmartNetBD/schema/` — 009 and 010 included, automatically, the moment they
...
public sealed class BaseDataTests
{
    ...
    public void NoVersionedScript_InsertsIntoFactUsuario()
    {
        var schemaPath = Path.GetFullPath(
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "..", "..", "SmartNetBD", "schema"));
        Assert.True(Directory.Exists(schemaPath), $"Expected to find SmartNet/SmartNetBD/schema/ at {schemaPath}.");
