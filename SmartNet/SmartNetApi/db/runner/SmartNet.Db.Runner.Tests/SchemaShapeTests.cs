...
/// scripts under SmartNet/SmartNetBD/schema/ (001-007), applied by the real runner against a throwaway
...
public sealed class SchemaShapeTests
{
    ...
    private static async Task<TestDatabaseFixture> MigratedDatabase()
    {
        ...
        try
        {
            // Phase 3 (Unit 3) added 008_usuarios_y_permisos.sql to SmartNet/SmartNetBD/schema/, which the
