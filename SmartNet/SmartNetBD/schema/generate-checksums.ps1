# Regenera SmartNet/SmartNetBD/schema/checksums.txt -- el manifiesto de hashes que compensa el hueco de
...
#
# Alcance: SOLO los scripts de nivel superior de SmartNet/SmartNetBD/schema/ (los que el runner realmente
...
# ordenado por nombre de archivo. ChecksumManifestTests.cs (SmartNet/SmartNetApi/db/runner/
