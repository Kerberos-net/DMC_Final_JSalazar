...
Aceptado. Reemplaza la versión previa (`adrs - v1/0010`), que agrupaba la superación de cuota con
...
- **Costo asumido:** el mecanismo de notificación vive dentro del worker. Si el worker se detiene,
  no hay quien avise, y el reinicio es manual (ADR 0001). Los logs del agregador (ADR 0015) son el
  único diagnóstico que sobrevive a esa situación.
